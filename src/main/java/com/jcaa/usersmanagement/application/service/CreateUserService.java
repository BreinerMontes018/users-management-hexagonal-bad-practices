...
public final class CreateUserService implements CreateUserUseCase {
  ...
  public UserModel execute(final CreateUserCommand command) {
    ...
    final UserModel userToSave = buildUser(command);
    ...
    private UserModel buildUser(final CreateUserCommand command) {
    ...
    private UserModel saveUser(final UserModel user) {
