...
public final class PersistenceException extends RuntimeException {
  ...
  public static PersistenceException becauseSaveFailed(
          final String userId,
          final Throwable cause) {

    return new PersistenceException(
            String.format(SAVE_FAILED_MESSAGE, userId),
            cause);
  }
  ...
  public static PersistenceException becauseUpdateFailed(
    ...
    return new PersistenceException(
            String.format(UPDATE_FAILED_MESSAGE, userId),
            cause);
  }
  ...
  public static PersistenceException becauseFindByIdFailed(
    ...
    return new PersistenceException(
            String.format(FIND_BY_ID_FAILED_MESSAGE, userId),
            cause);
  }
  ...
  public static PersistenceException becauseFindByEmailFailed(
    ...
    return new PersistenceException(
            String.format(FIND_BY_EMAIL_FAILED_MESSAGE, email),
            cause);
  }

  public static PersistenceException becauseFindAllFailed(
          final Throwable cause) {

    return new PersistenceException(
            FIND_ALL_FAILED_MESSAGE,
            cause);
  }
  ...
  public static PersistenceException becauseDeleteFailed(
    ...
    return new PersistenceException(
            String.format(DELETE_FAILED_MESSAGE, userId),
            cause);
  }
