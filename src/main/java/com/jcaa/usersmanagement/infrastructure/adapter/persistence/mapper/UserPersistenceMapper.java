...
public class UserPersistenceMapper {
  ...
  // correccion regla 4 usar UtilityClass y metodos static
  public static UserPersistenceDto fromModelToDto(
  ...
  public static UserEntity fromResultSetToEntity(
  ...
  public static UserModel fromEntityToModel(
  ...
  public static UserModel fromResultSetToModel(
          final ResultSet resultSet)
          throws SQLException {

    return fromEntityToModel(
            fromResultSetToEntity(resultSet));
  }

  public static List<UserModel> fromResultSetToModelList(
          final ResultSet resultSet)
          throws SQLException {
