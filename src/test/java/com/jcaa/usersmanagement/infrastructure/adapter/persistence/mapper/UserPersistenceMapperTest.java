...
class UserPersistenceMapperTest {
  ...
  void shouldMapModelToDto() {
    ...
    // Act
    final UserPersistenceDto result =
            UserPersistenceMapper.fromModelToDto(userModel);
  ...
  void shouldMapEntityToModel() {
    ...
    final UserModel result =
            UserPersistenceMapper.fromEntityToModel(userEntity);
  ...
  void shouldPropagateExceptionFromResultSet() throws SQLException {
    ...
    when(resultSet.getString(anyString()))
            .thenThrow(new SQLException("Column read failed"));
  ...
  void shouldReturnEmptyListWhenResultSetIsEmpty() throws SQLException {
    ...
    assertTrue(
            result.isEmpty(),
            "must return an empty list when ResultSet has no rows");
  }
  ...
  void shouldReturnOneModelPerRow() throws SQLException {
    ...
    assertEquals(
            2,
            result.size(),
            "must return one model per row in the ResultSet");
  }
  ...
  void shouldPropagateExceptionDuringIteration() throws SQLException {
    ...
    when(resultSet.getString(anyString()))
            .thenThrow(new SQLException("Row read failed"));
